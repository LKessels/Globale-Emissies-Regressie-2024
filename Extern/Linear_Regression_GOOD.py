...
filtered_df = PlaceComplete_DF[
    ((PlaceComplete_DF['region'] == 'Africa') | 
     (PlaceComplete_DF['region'] == 'Europe') | 
     (PlaceComplete_DF['region'] == 'Central and South America') | 
     (PlaceComplete_DF['region'] == 'North America') | 
     (PlaceComplete_DF['region'] == 'Russia & Caspian')) & 
...
sns.regplot(x='pm2.5 aqi value', y='ozone aqi value', data=filtered_df, 
            scatter_kws={'s': 100, 'color': 'blue', 'edgecolor': 'black'}, 
            line_kws={'color': 'red'})
